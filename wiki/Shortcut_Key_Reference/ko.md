...
- `Shift` + `Left Arrow`: 위의 그룹 보기
- `Shift` + `Right Arrow`: 아래의 그룹 보기
...
- `X`: 처음부터 재생
- `C` 또는 `Space`: 일시정지 / 일시정지 해제
- `Left Arrow` or `Right Arrow`: 1칸 이동
- `Up Arrow` or `Down Arrow`: timing point 사이 이동
- `Shift` + `Left Arrow` or `Shift` + `Right Arrow`: 4칸 이동
- `Ctrl` + `B`: 지금 위치의 북마크 추가
- `Ctrl` + `Shift` + `B`: 현제 위치의 북마크 제거
- `Ctrl` + `Left Arrow`: 이전 북마크로 이동
- `Ctrl` + `Right Arrow`: 다음 북마크로 이동
...
- `Ctrl` + `Down Arrow`: 재생속도 감소 25%
- `Ctrl` + `Shift` + `Down Arrow`: 재생속도 감소 5%
- `Ctrl` + `Up`: 재생속도 증가 25%
- `Ctrl` + `Shift` + `Up Arrow`: 재생속도 증가 5%
...
- `Ctrl` + `방향키`: 선택한 노트를 이동
- `Ctrl` + `방향키 좌/우` (mania 편집 모드에서): 선택한 노트를 column 단위로 이동 
- `Ctrl` + `방향키 상/하` (mania 편집 모드에서): 선택한 노트를 tick 단위로 이동 
...
- `Mouse Wheel Up`: 앞 시간으로 1칸 이동
- `Shift` + `Mouse Wheel Up`: 앞 시간으로 4칸 이동
- `Mouse Wheel Down`: 뒤 시간으로 1칸 이동
- `Shift` + `Mouse Wheel Down`: 뒤 시간으로 4칸 이동
- `Ctrl` + `Mouse Wheel`: 비트 배치 나눗수 증가 / 감소
- `Alt` + `Mouse Wheel`: 플레이 영역에서 하면 거리간격 조절. timeline 에서 하면 확대 / 축소
